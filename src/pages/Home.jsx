...
const Home = () => {
  ...
  return (
    <section className='w-full h-screen relative'>
      <div className='absolute top-28 left-0 right-0 z-10 flex items-center justify-center -mt-10'>
      ...
      <Canvas className={`w-full h-full bg-transparent ${isRotating ? 'cursor-grabbing': 'cursor-grab'}`} camera={{near: 0.1, far: 1000}}>
          <Suspense fallback={<Loader />}>
              ...
              <Island  position={islandPosition} scale={islandScale} rotation={[0.1, 4.7077, 0]} setIsRotating={setIsRotating} setCurrentStage={setCurrentStage} isRotating={isRotating}/>
